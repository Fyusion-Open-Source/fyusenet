...
//--------------------------------------------------------------------------------------------------
// Uniform Array for Transpose-Convolutional Layer 3x3xNxM Weights Shader (Header)
...
/**
 * @brief Weight array for transpose 3x3 convolution using 4-elements per pixel
 *
 * This class reformats the input weight/bias/bn data for use in transpose convolutions using a
 * 3x3 convolution kernel. In contrast to standard convolutional layers, the transposed convolution
 ...
 *
 * @see TransConvLayer3x3
 */
// TODO (mw) consolidate with 2x2 transconv weightarray to a more general class
class TransConvWeightArray3x3xNxM : public UniformWeightArray {
 public:
    constexpr static int STRATA = 4;
    // ------------------------------------------------------------------------
    // Constructor / Destructor
    // ------------------------------------------------------------------------
    TransConvWeightArray3x3xNxM(int stride, int inputChannels, int outputChannels, int maxRenderTargets);
    virtual ~TransConvWeightArray3x3xNxM();
