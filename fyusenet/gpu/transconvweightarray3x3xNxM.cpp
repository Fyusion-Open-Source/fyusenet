...
//--------------------------------------------------------------------------------------------------
// Uniform Array for Transpose-Convolutional Layer 3x3xNxM Weights Shader
 ...
 * computation.
 */
TransConvWeightArray3x3xNxM::TransConvWeightArray3x3xNxM(int stride, int inputChannels, int outputChannels, int maxRenderTargets) : UniformWeightArray() {
    assert(stride == 2);
    kernel_ = 3;
    stride_ = stride;
    markerOffset_ = 0;
 ...
 */
TransConvWeightArray3x3xNxM::~TransConvWeightArray3x3xNxM() {
}
 ...
 */
int TransConvWeightArray3x3xNxM::numInputRenderPasses() const {
 ...
 */
int TransConvWeightArray3x3xNxM::numOutputRenderPasses() const {
 ...
 */
int TransConvWeightArray3x3xNxM::numRenderTargets(int outputPass) const {
 ...
 */
int TransConvWeightArray3x3xNxM::outputTextureOffset(int outputPass) const {
 ...
 */
const float * TransConvWeightArray3x3xNxM::getPackageBias(int outputPass) const {
 ...
 */
const float * TransConvWeightArray3x3xNxM::getPackageBNScale(int outputPass) const {
    int offset = MRTOffsets_[outputPass]*PIXEL_PACKING;
 ...
 */
int TransConvWeightArray3x3xNxM::getPackageSize(int inputPass, int outputPass, int xIndex, int yIndex) const {
    int stratskips[4] = {0,1,3,5};
    int stratum = xIndex + 2 * yIndex;
    int offset = stratskips[stratum] * (paddedOutputChannels_/PIXEL_PACKING) * (paddedInputChannels_/PIXEL_PACKING);
    offset += (outputPass * (paddedInputChannels_ / PIXEL_PACKING) + inputPass);
 ...
 */
int TransConvWeightArray3x3xNxM::extractStratum1(const float *input, size_t inputOffset, int dstOffset) {
